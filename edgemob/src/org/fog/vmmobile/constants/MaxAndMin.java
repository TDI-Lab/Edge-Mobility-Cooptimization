...
public final class MaxAndMin {
	...
	public static final int AP_COVERAGE = 400; //1000 Max Ap coverage distance - It should modify
	public static final int CLOUDLET_COVERAGE = 2000; //1000 Max cloudlet distance - It should modify
	...
	public static final int MAX_SIMULATION_TIME = 1000*600*30; //30 minutes
