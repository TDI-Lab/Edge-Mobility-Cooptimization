...
/**
 * @author Zeinab
 * windows: different profiles
 * Mobility: default[0]:10112, optimized[1]:9788
 * "NUM_SMART_VEHICLES":[10112,9788,10112,9788,10112,9788],
 *  note:
 * 	public static double cpuUtilRatio = 0.9;			
	public static double memUtilRatio = 0.9;
	public static double stoUtilRatio = 0.9;
 *  
 */
public class Run4 {
    ...
    private static int index = 1;				//[1:188], traffic index increasing: "08:45"[35-47], top:"12:00"[48-62]wrong

    public static void main(String[] args) throws FileNotFoundException {
    	
    	System.out.println("Placement methods with soft constraint started at "+System.currentTimeMillis());
    	setSeed(290538);
    	
    	//double [] a = new double[10]; 
    	//RandomGenerator.fillRandomBetaInArrayInRange(a);
		...
		System.out.println(Constants.SC_RenewablePortion);
	...
	for (int i=lb; i<ub; i++) {
        ...
        Utility.dataPrep();
        System.out.println("\nRuns are completed at "+System.currentTimeMillis());
    }
    }//end index
	...
	public static void setServerCloudlets(List<FogDevice> serverCloudlets) {
		Run4.serverCloudlets = serverCloudlets;
	}
	...
	public static void setCoordDevices(Coordinate coordDevices) {
		Run4.coordDevices = coordDevices;
	}
	...
	public static void setMaxSmartThings(int maxSmartThings) {
		Run4.maxSmartThings = maxSmartThings;
	}
